...
./build.sh start
./build.sh cli mix_stream_recorder_audio_video_water_marks.json
```
...
http://10.200.0.85:18080/api/recording/start?configFileName=single_stream_recorder_audio_video.json

http://10.200.0.85:18080/api/recording/start?configFileName=capture_type_encoded_frame.json

http://10.200.0.85:18080/api/recording/start?configFileName=capture_type_encoded_frame_mix_stream.json

http://10.200.0.85:18080/api/recording/start?configFileName=capture_type_yuv_frame_single_stream.json
